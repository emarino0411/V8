...
<head>
    ...
    <!-- Custom Fonts -->
    <link href="agency/font-awesome/css/font-awesome.min.css" rel="stylesheet" type="text/css">
    ...
    <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand page-scroll" href="#page-top">Crowd To Go</a>
            </div>
    ...
    <header>
        <div class="container">
            <div class="intro-text">
                ...
                <a href="#services" class="page-scroll btn btn-xl">Be A Crowdie</a>
                <a href="#services" class="page-scroll btn btn-xl">Be A Merchant</a>
            </div>
        </div>
    </header>
